  ...
  ["409"],
  {
    7199: function (t) {
      var r = window.jQuery,
        ...
        o = {
          ...
          intro: function (t, i) {
            i.__wf_intro ||
              ((i.__wf_intro = !0), r(i).triggerHandler(n.types.INTRO));
          },
          outro: function (t, i) {
            i.__wf_intro &&
              ((i.__wf_intro = null), r(i).triggerHandler(n.types.OUTRO));
          },
        };
      (n.triggers = {}),
        (n.types = { INTRO: "w-ix-intro" + e, OUTRO: "w-ix-outro" + e }),
        (n.init = function () {
    ...
    5134: function (t, r, n) {
      ...
      var o = window.jQuery,
        ...
        s = ".w-ix";
      (u.triggers = {}),
        (u.types = { INTRO: "w-ix-intro" + s, OUTRO: "w-ix-outro" + s }),
        o.extend(u.triggers, {
          reset: function (t, r) {
